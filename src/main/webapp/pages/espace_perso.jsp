...
<body>
	...
	<c:if test="${user != null}">
		...
		<a href="/servletAnnonce" class="nav-link" >espace public</a>
...
<div class="menu">
	...
	<form action="/exportperso/{user.getId()}">
		<input type="submit" class="btn btn-primary" value="exporter mes données en pdf"/>
	</form>
